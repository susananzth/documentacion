    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <TitleSubtitle 
                    title='Data Science'
                    subTitle='Documentación Data Science'
                />
                ...
                <div className="accordion">
                    ...
                    <AccordionItem id="content" title="Contenido">
                        <li className="accordion">
                            <AccordionItem id="data" title="¿Qué es Data Science?">
                                <p>
                        ...
                        <li className="accordion">
                            <AccordionItem id="science" title="Diferencia entre inteligencia artificial y Data Science">
                                <p>
                        ...
                        <li className="accordion">
                            <AccordionItem id="big" title="Big Data">
                                <p>
                        ...
                        <li className="accordion">
                            <AccordionItem id="noData" title="¿Qué no es Data Science?">
                                <p>
                        ...
                        <li className="accordion">
                            <AccordionItem id="areas" title="Áreas de aplicación de Data Science e inteligencia artificial">
                                <p>
                        ...
                        <li className="accordion">
                            <AccordionItem id="roles" title="Roles en la industria: cómo funcionan los equipos de datos e inteligencia artificial">
                                <p>
                        ...
                        <li className="accordion">
                            <AccordionItem id="dataAnalist" title="¿Qué hace una Data Analyst?">
                                <p>
